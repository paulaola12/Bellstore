<nav class="grid__item" id="AccessibleNav"><!-- for mobile -->
    ...
    <li class="lvl1"><a href="{{ route('index') }}"><b>Home</b> <i class="anm anm-angle-down-l"></i></a></li>  
    <li class="lvl1"><a href="{{ route('products') }}"><b>Shop</b> <i class="anm anm-angle-down-l"></i></a></li>
