                            ...
                            <div class="row">
                                   <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="product_name" placeholder="" id="LastName">
                                        </div>
                                        @error('product_name')
                                   ...
                                   <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="price" placeholder="" id="CustomerEmail" class="" autocorrect="off" autocapitalize="off" autofocus="">
                                    </div>
                                    @error('price')
                                        <p class="text-primary">{{ $message }}</p>
                                    @enderror
