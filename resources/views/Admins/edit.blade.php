                ...
                <div class="row">
                    ...
                    <div class="col-2 col-sm-4 col-md-3 col-lg-4 text-right">
                        ...
                        <ul class="customer-links list-inline">
                            ...
                            <li><a href="{{ route('register') }}">Update Account</a></li>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-12 col-sm-12 col-md-6 col-lg-6 main-col offset-md-3">
                        <div class="mb-4">
                          <form action="/admin/update/{{$update_products->id}}" method="post" enctype="multipart/form-data" >	
                              @csrf
                              @method('PUT')
                            ...
                            <div class="row">
                                   <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="product_name" placeholder="{{ $update_products->product_name }}" id="LastName">
                                        </div>
                                        @error('product_name')
                                   ...
                                   <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                                    <div class="form-group">
                                        <label for="CustomerEmail">Price</label>
                                        <input type="number" name="price" placeholder="{{ $update_products->price }}" id="CustomerEmail" class="" autocorrect="off" autocapitalize="off" autofocus="">
                                    </div>
                                    @error('price')
                                        <p class="text-primary">{{ $message }}</p>
                                    @enderror
                                  ...
                                  <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                                    <div class="form-group">
                                        <label for="LastName">Decription</label>
                                        <input type="text" name="description" placeholder="{{ $update_products->description }}" >
                                    </div>
                                    @error('description')
                                        <p class="text-primary">{{ $message }}</p>
                                    @enderror
                                ...
                                <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                                  <div class="form-group">
                                      <label for="CustomerPassword">Pictures</label>
                                      <input type="file" value="" name="picture" placeholder="" id="CustomerPassword" class="">                        	
                                  </div>
                                  @error('picture')
                                      <p class="text-primary">{{ $message }}</p>
                                  @enderror
