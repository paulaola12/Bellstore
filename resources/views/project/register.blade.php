                            ...
                            <div class="row">
                                   <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="name" placeholder="" id="LastName">
                                        </div>
                                        @error('name')
                                ...
                                <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                                  <div class="form-group">
                                      ...
                                      <input type="number" name="phonenumber" placeholder="" id="CustomerEmail" class="" autocorrect="off" autocapitalize="off" autofocus="">
                                  </div>
                                  @error('phonenumber')
                                      <p class="text-primary">{{ $message }}</p>
                                  @enderror
                                   ...
                                   <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="address" placeholder="" id="LastName">
                                        </div>
                                        @error('address')
                                            <p class="text-primary">{{ $message }}</p>
                                        @enderror
