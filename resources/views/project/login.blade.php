            ...
            <div class="row">
                  <div class="col-12 col-sm-12 col-md-6 col-lg-6 main-col offset-md-3">
                    <div class="mb-4">
                         ...
                         <form method="post" action="{{ route('logina') }}" id="CustomerLoginForm" accept-charset="UTF-8" class="contact-form">	
                            @csrf
                          <div class="row">
                            ...
                            <div class="row">
                              <div class="text-center col-12 col-sm-12 col-md-12 col-lg-12">
                                  <button type="submit" class="btn mb-3" value="Sign In"> Submit </button>
                                  <p class="mb-4">
